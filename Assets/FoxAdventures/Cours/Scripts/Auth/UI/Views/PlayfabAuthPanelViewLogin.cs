...
public class PlayfabAuthPanelViewLogin : PlayfabAuthPanelView
{
    ...
    private void OnLoginError(PlayFabError error)
    {
        ...
        bool accountNotFound = (error.ErrorMessage.Contains("User not found") && error.ErrorMessage.Contains("entity type 'title_player_account'"));

        // Check if error is related to user not found
        bool userNotFound = (error.ErrorMessage.Contains("User not found") && error.ErrorMessage.Contains("entity type 'title_player_account'") == false);
