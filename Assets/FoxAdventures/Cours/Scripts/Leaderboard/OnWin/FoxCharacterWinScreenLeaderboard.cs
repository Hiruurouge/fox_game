...
public class FoxCharacterWinScreenLeaderboard : FoxCharacterWinScreenAddCrystals
{
    protected override void OnWin()
    {
        ...
        if (foxCharacterInventory != null)
        {
            ...
            PlayfabInventory.Instance.UpdateLeaderboardEntry("level1_crystals", crystalsCount);
            PlayfabInventory.Instance.UpdateLeaderboardEntry("level1_speedrun", Mathf.FloorToInt(levelDuration * 100.0f * -1.0f));
            // TODO: Update our best score on level 1
